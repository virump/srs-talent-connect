...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        // Layered, low-opacity shadows read as "modern" far better than a single hard drop
        soft: '0 1px 2px 0 hsl(240 10% 4% / 0.04), 0 1px 3px 0 hsl(240 10% 4% / 0.06)',
        card: '0 1px 3px 0 hsl(240 10% 4% / 0.05), 0 4px 12px -2px hsl(240 10% 4% / 0.06)',
        lift: '0 8px 30px -6px hsl(240 10% 4% / 0.14), 0 2px 8px -2px hsl(240 10% 4% / 0.08)',
        glow: '0 0 24px -4px hsl(var(--brand-500) / 0.5)',
